...
/**
 * [McpTool] against the same real fake stdio server [StdioMcpClientTest] uses — proving the
 * broker-facing `execute()` seam the audit found entirely missing actually drives a real MCP
 * call end to end, not just the descriptor-mapping half ([McpAdapterTest]).
 */
class McpToolTest {
