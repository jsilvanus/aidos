#!/usr/bin/env python3
"""Echo a whole string with `echo.gguf` under real llama.cpp.
...
def main() -> int:
    ...
    parser.add_argument("-m", "--model", type=pathlib.Path, default=pathlib.Path(__file__).with_name("echo.gguf"))
